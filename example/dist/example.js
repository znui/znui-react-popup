...
(function (t, e) {
  ...
  t.exports = zn.Class({
    ...
    methods: {
      ...
      update: function t(e) {
        ...
        setTimeout(function () {
          return r(4).render(i, _container);
        }, 50);
      }
    }
  });
  ...
  t.exports = zn.Class({
    methods: {
      ...
      __addRippleEffect: function t(e) {
        var n = e.target;

        if (!n.classList.contains("zr-action-ripple")) {
          return false;
        }

        var i = n.getBoundingClientRect(),
            r = n.querySelector(".zr-ripple");

        if (!r) {
          r = document.createElement("span");
          r.className = "zr-ripple";
          r.style.height = r.style.width = Math.max(i.width, i.height) + "px";
          n.appendChild(r);
        }

        r.classList.remove("show");
        var o = e.pageY - i.top - r.offsetHeight / 2 - document.body.scrollTop;
        var a = e.pageX - i.left - r.offsetWidth / 2 - document.body.scrollLeft;
        r.style.top = o + "px";
        r.style.left = a + "px";
  ...
  t.exports = r(i.Component, i.isValidElement, o);
}, function (t, e) {
  (function () {
  ...
  function o(t, h, o) {
    ...
    function r(t, e) {
      ...
      for (var n in e) {
        ...
        var r = n in y;
        D(!r, "ReactClass: You are attempting to define a reserved " + 'property, `%s`, that shouldn\'t be on the "statics" key. Define it ' + "as an instance property instead; it will still be accessible on the " + "constructor.", n);
        var o = n in t;
    ...
    function _(t) {
      var r = x(function (t, e, n) {
        ...
        D(typeof i === "object" && !Array.isArray(i), "%s.getInitialState(): must return an object or null", r.displayName || "ReactCompositeComponent");
        this.state = i;
      });
      r.prototype = new E();
      r.prototype.constructor = r;
      r.prototype.__reactAutoBindPairs = [];
      n.forEach(i.bind(null, r));
      i(r, l);
      i(r, t);
      i(r, f);

      if (r.getDefaultProps) {
        r.defaultProps = r.getDefaultProps();
      }

      if (false) {}

      D(r.prototype.render, "createClass(...): Class specification must implement a `render` method.");
  ...
  */
  ...
  function i() {
    try {
      ...
      if (Object.keys(Object.assign({}, r)).join("") !== "abcdefghijklmnopqrst") {
        return false;
      }
